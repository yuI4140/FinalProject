...
#include <array>
namespace Setcolor{
    const std::array<std::string, 14> mh_Red = {
      ...
      const std::array<std::string, 14> mh_Pink = {
      ...
      const std::array<std::string, 14> mh_Purple = {
      ...
      const std::array<std::string, 14> mh_deepPurple = {
      ...
      const std::array<std::string, 14> mh_Indigo = {
      ...
      const std::array<std::string, 14> mh_Blue = {
      ...
      const std::array<std::string, 14> mh_lightBlue = {
      ...
      const std::array<std::string, 14> mh_Cyan = {
      ...
      "##00acc1","#0097a7","#00838f",
       ...
       const std::array<std::string, 14> mh_Teal = {
      ...
      const std::array<std::string, 14> mh_Green = {
      ...
      const std::array<std::string, 14> mh_lightGreen = {
      ...
      const std::array<std::string, 14> mh_Lime = {
      "#f9fbe7","#f0f4c3","#e6ee9c",
      "#dce775","#d4e157","#cddc39",
      "#c0ca33","#afb42b","#9e9d24",
       "#827717","#f4ff81","#eeff41",
       "#c6ff00","#aeea00"
      };
      const  std::array<std::string, 14> mh_Yellow = {
      ...
      const std::array<std::string, 14> mh_Amber = {
      "#fff8e1","#ffecb3","#ffe082",
      "#ffd54f","#ffca28","#ffc107",
      "#ffb300","#ffa000","#ff8f00",
       "#ff6f00","#ffe57f","#ffd740",
       "#ffc400","#ffab00"
      };
     const std::array<std::string, 14> mh_Orange = {
     ...
     const std::array<std::string, 14> mh_deepOrange = {
      ...
      const std::array<std::string, 14> mh_Brown = {
      "#efebe9","#d7ccc8","#bcaaa4",
      "#a1887f","#8d6e63","#795548",
      "#6d4c41","#5d4037","#4e342e",
       "#3e2723"
      };
     const std::array<std::string, 14> mh_Grey = {
      "#fafafa","#f5f5f5","#eeeeee",
      "#e0e0e0","#bdbdbd","#9e9e9e",
      "#757575","#616161","#424242",
       "#212121"
      };
     const std::array<std::string, 14> mh_blueGrey = {
